			...
			if($_SESSION['permit'] == 2)
			{
				echo "<tr  bgcolor='#FCFCFC' height = '50'>
				       ...
				       <th width='25%'>
						...
						<tr  bgcolor="#FCFCFC" height = "50">
							<th  colspan="5">
								受控設備名稱：<input type="text" Name="Name" size="10" maxlength="4">&nbsp&nbsp
								Wi-SUN IP：<input type="text" Name="IP"   size="20" maxlength="20">&nbsp&nbsp
								經度：<input type="text" Name="x"   size="10" maxlength="4">&nbsp&nbsp
								緯度：<input type="text" Name="y"   size="10" maxlength="4">&nbsp&nbsp
					...
					<table border="2" width="80%" align="center"><br>
						...
						<tr  bgcolor="#FCFCFC">
							<th>
								受控設備名稱&nbsp&nbsp:&nbsp&nbsp<input type="text" Name="del" size="8"/ >&nbsp&nbsp
					...
					<table border="2" width="80%" align="center"><br>
						...
						<tr  bgcolor="#FCFCFC">
						<th width="100">名稱</th><th width="200">Wi-SUN IPv6 位址</th><th width="240">設備狀態</th><th width="240"> LEDs 狀態</th>
					<?php
